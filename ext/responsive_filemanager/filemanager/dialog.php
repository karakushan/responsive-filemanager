...
), array( '' ), $base_url . $_SERVER['REQUEST_URI'] ); ?>"/>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span2 half view-controller">
                                <button class="btn tip<?php if ( $view == 0 ) {
									echo " btn-inverse";
								} ?>" id="view0" data-value="0" title="<?php echo trans( 'View_boxes' ); ?>"><i
                                            class="icon-th <?php if ( $view == 0 ) {
												echo "icon-white";
											} ?>"></i></button>
                                <button class="btn tip<?php if ( $view == 1 ) {
									echo " btn-inverse";
								} ?>" id="view1" data-value="1" title="<?php echo trans( 'View_list' ); ?>"><i
                                            class="icon-align-justify <?php if ( $view == 1 ) {
												echo "icon-white";
											} ?>"></i></button>
                                <button class="btn tip<?php if ( $view == 2 ) {
									echo " btn-inverse";
								} ?>" id="view2" data-value="2" title="<?php echo trans( 'View_columns_list' ); ?>"><i
                    ...
                    <figure data-name="<?php echo $file ?>" data-type="<?php if ( $is_img ) {
                        ...
                        <figcaption>
                            <form action="force_download.php" method="post" class="download-form"
								...
								<?php } elseif ( in_array( $file_array['extension'], array(
									'dwg',
									'dxf',
									'hpgl',
									'plt',
